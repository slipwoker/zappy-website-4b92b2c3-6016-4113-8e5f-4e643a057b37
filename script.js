document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll('.fade-in, .scroll-animate, [data-animate]');
  ...
  if (animatedElements.length > 0) {
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkVisibility() {
        ...
        animatedElements.forEach(function (el) {
          if (el.classList.contains('animate-visible')) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מוזיאיליקי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4b92b2c3-6016-4113-8e5f-4e643a057b37',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4b92b2c3-6016-4113-8e5f-4e643a057b37';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b92b2c3-6016-4113-8e5f-4e643a057b37';
